 ...
 const toastId = toast.loading("Sending your message , please wait....")
    emailjs.send(process.env.NEXT_PUBLIC_SERVICE_ID,
         ...
         params,
     {
        ...
        limitRate: {
          throttle:5000, //you cant send more than 1 email per 5 seconds
        },
      })
      .then(
        () => {
         toast.success('I have received your message , I will get back to you . Thanks!',{id:toastId})
        },
        (error) => {
          toast.error('There was an error sending your message , Please try again later. Thanks!',{id:toastId})
        },
      );
  };
  const onSubmit = (data) =>{
  ...
  return (
    ...
    >
      ...
      <motion.input type="email"
       placeholder="Email" {...register("email", {required: 'This feild is required'})}
       className='w-full p-2 rounded-md shadow-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 custom-bg'
      />
      {
      ...
      variants={item}
      placeholder="Message" 
      {...register("message", {required:'This feild is required', maxLength:{
        value:500,
